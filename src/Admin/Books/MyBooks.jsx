...
// My Books Component in Trade Excelsior Project with API configuration from backend 
  ...
  useEffect(() => {
    const fetchBooks = async () => {
      try {
        ...
        setBooks(response.data); // Assumes array of books
      } catch (err) {
          ...
          <Grid item xs={12} md={12} key={book.id}>
            ...
            >
              ...
              {!isMobile && !isTablet && (
                <CardMedia
                  component="img"
                  sx={{ width: "300px", height: "450px", borderRadius: "5px" }}
                  image={book.image}
                  alt={book.bookName}
                />  
              )}
