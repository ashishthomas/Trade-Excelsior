  ...
  return (
    ...
    >
      ...
      <TextField
        ...
        id="phoneNumber"
        name="phoneNumber"
        label={<>phoneNumber <span style={{color:"red"}}>*</span></>}
        variant="outlined"
        sx={{ width: "100%", mb: 1 }}
      ...
      <TextField
        ...
        name="license"
        select
        label={<>License <span style={{color:"red"}}>*</span></>}
        sx={{ width: "100%", mb: 1 }}
      ...
      <TextField
        ...
        label={<>Subscription Duration (in years) <span style={{color:"red"}}>*</span></>}
        type="name"
        variant="outlined"
        sx={{ width: "100%", mb: 1 }}
        ...
        onChange={formik.handleChange}
        onBlur={formik.handleBlur}
        error={formik.touched.subscriptionDuration && Boolean(formik.errors.subscriptionDuration)}
        helperText={formik.touched.subscriptionDuration && formik.errors.subscriptionDuration}
      />
